...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--batch-manifest",
        default=str(PROJECT_ROOT / "outputs" / "issue_reaudit_round3" / "manifests" / "batch_manifest.csv"),
    )
    parser.add_argument(
        "--batch-summary",
        default=str(PROJECT_ROOT / "outputs" / "issue_reaudit_round3" / "manifests" / "batch_summary.csv"),
    )
    parser.add_argument(
        "--output-dir",
    ...
    parser.add_argument(
        "--merged-file",
        default=str(PROJECT_ROOT / "outputs" / "issue_reaudit_round3" / "issue_reaudit_merged.csv"),
    )
    parser.add_argument(
        "--overlay-file",
    ...
    parser.add_argument(
        "--summary-json",
        default=str(PROJECT_ROOT / "outputs" / "issue_reaudit_round3" / "issue_reaudit_summary.json"),
    )
    parser.add_argument(
        "--summary-csv",
        default=str(PROJECT_ROOT / "outputs" / "issue_reaudit_round3" / "issue_reaudit_summary.csv"),
    )
